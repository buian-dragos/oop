...
class HTML_file : public UserService{
public:
    HTML_file(const EventRepo& er, const UserRepo& ur)
            : UserService(er, ur) {
    }
...
class CSV_file : public UserService{
public:
    CSV_file(const EventRepo& er, const UserRepo& ur)
            : UserService(er, ur) {
    }
    void save_file() override;
    void open_file() override;
